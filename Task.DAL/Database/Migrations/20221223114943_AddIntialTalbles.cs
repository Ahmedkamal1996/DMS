...
{
    public partial class AddIntialTalbles : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerDescriptionEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CustomerDescriptionAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHeaders_Customer_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_UnitOfMeasure_UOMId",
                        column: x => x.UOMId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_UnitOfMeasure_UOMId",
                        column: x => x.UOMId,
                        principalTable: "UnitOfMeasure",
                        principalColumn: "Id",
